...
> **For agentic workers:** REQUIRED: Use react-native-space:subagent-driven-development (if subagents available) or react-native-space:executing-plans to implement this plan.
...
**Spec:** docs/react-native-space/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/react-native-space/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use react-native-space:subagent-driven-development (if subagents available) or react-native-space:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
