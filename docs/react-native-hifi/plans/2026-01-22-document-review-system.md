...
> **For agentic workers:** REQUIRED: Use react-native-hifi:subagent-driven-development (if subagents available) or react-native-hifi:executing-plans to implement this plan.
...
**Spec:** docs/react-native-hifi/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/react-native-hifi/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use react-native-hifi:subagent-driven-development (if subagents available) or react-native-hifi:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
