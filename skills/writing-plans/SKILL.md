...
**Save plans to:** `docs/react-native-hifi/plans/YYYY-MM-DD-<feature-name>.md`
...
- **REQUIRED SUB-SKILL:** Use react-native-hifi:subagent-driven-development
- Fresh subagent per task + two-stage review

**If Inline Execution chosen:**
- **REQUIRED SUB-SKILL:** Use react-native-hifi:executing-plans
