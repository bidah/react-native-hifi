...
mkdir -p "$HOME/.config/opencode/react-native-space"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/react-native-space/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/react-native-space/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/react-native-space/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/react-native-space.js" "$HOME/.config/opencode/react-native-space/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/react-native-space/.opencode/plugins/react-native-space.js" \
       "$HOME/.config/opencode/plugins/react-native-space.js"
...
echo "Plugin installed to: $HOME/.config/opencode/react-native-space/.opencode/plugins/react-native-space.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/react-native-space.js"
