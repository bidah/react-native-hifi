...
mkdir -p "$HOME/.config/opencode/react-native-hifi"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/react-native-hifi/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/react-native-hifi/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/react-native-hifi/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/react-native-hifi.js" "$HOME/.config/opencode/react-native-hifi/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/react-native-hifi/.opencode/plugins/react-native-hifi.js" \
       "$HOME/.config/opencode/plugins/react-native-hifi.js"
...
echo "Plugin installed to: $HOME/.config/opencode/react-native-hifi/.opencode/plugins/react-native-hifi.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/react-native-hifi.js"
