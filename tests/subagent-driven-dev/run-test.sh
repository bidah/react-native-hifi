...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/react-native-hifi
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/react-native-hifi-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using react-native-hifi:subagent-driven-development. The plan is at: $PLAN_PATH"
