...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/react-native-space
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/react-native-space-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using react-native-space:subagent-driven-development. The plan is at: $PLAN_PATH"
