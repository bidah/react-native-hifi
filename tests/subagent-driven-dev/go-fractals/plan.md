...
Execute this plan using the `react-native-space:subagent-driven-development` skill.
...
**Do:**
- Initialize `go.mod` with module name `github.com/react-native-space-test/fractals`
