...
Execute this plan using the `react-native-hifi:subagent-driven-development` skill.
...
**Do:**
- Initialize `go.mod` with module name `github.com/react-native-hifi-test/fractals`
